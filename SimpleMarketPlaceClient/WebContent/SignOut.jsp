	...
	<body>
		<header>
     	...
     	<div class="panel panel-primary checkoutBody">
        	<div class="panel-heading">Thank you for visiting MarketPlace</div>
	        <div class="panel-body">
	           <form class="form-horizontal" role="form">
			               <div class="form-group  usernameDiv">
			                  <label class="checkout control-label pull-left" style="margin-left: 2%;">Want to visit again ?? Please Sign-in </label>
			               </div>
		          </form>
	        </div>
		</div>
